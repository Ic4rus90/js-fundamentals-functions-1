...
function addSmiley(name) {
  const capitalizedName = firstCharToUpperCase(name)
...
module.exports = {
  ...
  b: firstCharToUpperCase, // 2. change undefined to be the name of the function you defined for the second TODO)
  c: addSmiley, // etc
  d: countStrings,
  e: addEdward
}
